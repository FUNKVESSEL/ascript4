(module
 ...
 (data (i32.const 176) "\10\00\00\00\01\00\00\00\01\00\00\00\10\00\00\00A\00s\00B\00i\00n\00d\00:\00 \00")
 (data (i32.const 208) "\08\00\00\00\01\00\00\00\01\00\00\00\08\00\00\00n\00u\00l\00l\00")
 ...
 (export "myExportedFunctionThatTakesAString" (func $assembly/main/myExportedFunctionThatTakesAString))
 ...
 (func $~lib/string/String#concat (; 17 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/string/String.__concat (; 18 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $assembly/main/myExportedFunctionThatTakesAString (; 19 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
 ...
 (func $~lib/rt/pure/__visit (; 23 ;) (param $0 i32) (param $1 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.lt_u
  if
 ...
 (func $~lib/rt/__visit_members (; 24 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
