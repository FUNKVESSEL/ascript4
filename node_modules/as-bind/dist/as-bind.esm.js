...
{this.exports[a].shouldCacheTypes=!1})}enableImportFunctionTypeCaching(){I(this.importObject,[],(a,b,d)=>{a[d].shouldCacheTypes=!0})}disableImportFunctionTypeCaching(){I(this.importObject,[],(a,b,d)=>{a[d].shouldCacheTypes=!1})}}let K={version:"0.1.4",instantiate:async(a,b)=>{let d=new J;await d._instantiate(a,b);return d},instantiateSync:(a,b)=>{let d=new J;d._instantiateSync(a,b);return d}};export default K;var AsBind=K;export{AsBind};
